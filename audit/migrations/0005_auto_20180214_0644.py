# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2018-02-14 06:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeout', models.IntegerField(default=300, verbose_name='任务超时时间(s)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('result', models.TextField(verbose_name='命令结果')),
                ('date', models.DateTimeField(auto_now_add=True)),
