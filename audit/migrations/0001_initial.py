# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2018-02-12 14:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hostname', models.CharField(max_length=64, unique=True, verbose_name='昵称')),
                ('ip_addr', models.GenericIPAddressField(unique=True, verbose_name='ip')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('auth_type', models.SmallIntegerField(choices=[(0, 'ssh-password'), (1, 'ssh-key')], verbose_name='连接方式')),
                ('username', models.CharField(max_length=32, verbose_name='连接用户名')),
                ('password', models.CharField(blank=True, max_length=128, null=True, verbose_name='如是密钥无需密码')),
            ],
        ),
        migrations.CreateModel(
            name='HostUserBind',
